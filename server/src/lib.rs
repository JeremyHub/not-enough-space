...
pub const MAX_ORBITING_MOON_SIZE: f32 = MAX_HEALTH_SACRIFICE.max(MAX_FREE_MOON_SIZE);
pub const MIN_ORBIT_RADIUS_BY_USER_SIZE: f32 = 0.05;

// moon sacrifice
pub const MAX_HEALTH_SACRIFICE: f32 = 10.0;
pub const MIN_HEALTH_SACRIFICE: f32 = 3.0;
pub const SACRIFICE_SPEED_BOOST: f32 = USER_ACCELERATION / 2.0;

// moon common
pub const MAX_POSSIBLE_MOON_SIZE: f32 = MAX_FREE_MOON_SIZE.max(MAX_ORBITING_MOON_SIZE);
